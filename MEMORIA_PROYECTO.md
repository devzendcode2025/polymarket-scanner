...
- **Cron (2026-08-20):** scan 1/min y backup diario PAUSADOS por pedido del usuario (necesitaba los tokens). Reactivación automática el 2026-08-23 02:05 UTC vía job one-shot `polymarket-reactivar-3dias` (perfil codigo, script resume-polymarket.sh). No se borró nada; verificar estado tras esa fecha.
- **Última actualización:** 2026-08-20 — pausa temporal del cron por tokens (reactiva 2026-08-23). Antes: 2026-08-19 — v0.8.2: recall v2 de edges (2.3x candidatos) + mispricings del libro real (CLOB orderbook, cache SQLite, lotes 30/corrida); hallazgo Gamma normaliza precios; umbral vol $5k y cola 600.
