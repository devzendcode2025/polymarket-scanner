...
- **Estado:** Sistema automático COMPLETO + v0.8.1 — 2026-08-18: v0.8.0 (cron 1min, poda disco, sitio público, mobile, español, filtro país, categorías, analista heurístico, F4 narrativa DeepSeek, F3 edges con confirmación LLM, histórico aciertos, backup 03:00 UTC) + RECALL BOOST DE EDGES: fuente ESPN añadida (19 ligas, moneyline DraftKings → mercados sintéticos "Winner: A vs B" sin vig), Kalshi arreglado (API migró a yes_ask_dollars/title; parlays 596/600 filtrados), Manifold 500, matching con bigramas de nombres propios, top-2 candidatos por fuente, MAX_POLY 400, MAX_CANDIDATOS 150, prompt DeepSeek exigiendo mismo tipo de mercado, filtro determinista (Winner: solo vs winner), dedupe por game_id en consenso.
